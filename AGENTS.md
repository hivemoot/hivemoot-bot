...
- Environment variables may include quotes/whitespace in hosted setups; use normalization helpers in `api/lib/env-validation.ts` and `api/lib/llm/provider.ts`.
