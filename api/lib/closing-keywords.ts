/**
 * Detect whether PR body text appears to contain a closing-keyword reference
 * for the current repository (or an unqualified local #N reference).
 *
 * This is intentionally a heuristic for webhook UX guards, not a replacement
 * for GitHub's canonical closingIssuesReferences parsing.
 */
